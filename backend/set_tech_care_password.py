...
team_id = 532  # Tech care team ID
new_password = "Payal@techcare123"
...
try:
    ...
    print(f"Successfully updated password for {updated_count} users of 'Tech care' (Team ID: {team_id}) to: {new_password}")
